...
<div class="max-w-4xl mx-auto py-8 px-4">
    ...
    <div class="glass-card rounded-[2.5rem] overflow-hidden bg-white dark:bg-slate-800/80 shadow-xl border-2 border-lime-100">
        <div class="p-8 sm:p-12 border-b border-lime-100 bg-gradient-to-br from-lime-50 to-white">
            ...
            <p class="mt-4 text-slate-500 dark:text-slate-400 font-bold text-xs uppercase tracking-widest">
        ...
        <div class="p-8 bg-slate-50 dark:bg-slate-900/50 border-t border-lime-100 flex justify-center">
            <a href="{{ route('register') }}" class="group flex items-center gap-3 font-heading text-sm text-lime-700 hover:text-lime-900 transition">
                <span class="p-2 bg-white dark:bg-slate-800 rounded-xl shadow-sm group-hover:shadow-md transition">←</span>
