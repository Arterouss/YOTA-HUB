...
<head>
    ...
    <title>Admin Workspace | {{ config('app.name', 'YOTA HUB') }}</title>
...
<body class="bg-slate-50 dark:bg-slate-950 min-h-screen text-slate-900 dark:text-slate-100 antialiased overflow-x-hidden flex flex-col md:flex-row">
    ...
    <div class="flex-1 flex flex-col min-w-0 min-h-screen pb-24 md:pb-0 relative">
        <main class="flex-1 p-4 md:p-8 lg:p-12 relative z-10 w-full min-h-screen">
