...
<div class="min-h-screen bg-slate-50 dark:bg-slate-900 p-8">
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-2xl font-black text-slate-900 dark:text-white uppercase tracking-tight">🏆 Panel Penilaian & Piagam</h1>
                <p class="text-slate-500 dark:text-slate-400 text-sm mt-1">Pilih modul untuk melihat daftar mahasiswa yang perlu dinilai.</p>
            </div>
        ...
        <div class="grid gap-6">
            ...
            <div class="bg-white dark:bg-slate-800 rounded-2xl p-16 text-center border border-slate-100 dark:border-slate-700">
                ...
                <p class="font-bold text-slate-600 dark:text-slate-400">Belum ada modul E-Learning. <a href="{{ route('admin.learning.create') }}" class="text-lime-600 underline">Tambah modul sekarang →</a></p>
            </div>
            @endforelse
        </div>
    </div>
