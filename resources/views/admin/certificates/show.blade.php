                        ...
                        <td class="px-6 py-4 text-right">
                            ...
                            <form action="{{ route('admin.certificates.publish', [$module->id, $student->id]) }}" method="POST" class="inline-flex items-center gap-2">
                                ...
                                <input type="number" name="grade" min="0" max="100" required
                                       ...
                                       class="w-20 px-3 py-1.5 border border-slate-200 dark:border-slate-700 rounded-lg text-sm text-center font-bold focus:outline-none focus:ring-2 focus:ring-lime-400"
                                       placeholder="Nilai">
                                <button type="submit"
