...
<div class="sm:flex sm:items-center sm:justify-between mb-8">
    <div>
        <a href="{{ route('admin.learning.index') }}" class="text-xs font-bold text-slate-500 dark:text-slate-400 hover:text-lime-600 mb-2 inline-block">← KEMBALI KE DAFTAR KURSUS</a>
