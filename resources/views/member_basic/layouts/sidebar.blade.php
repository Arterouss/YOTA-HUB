<div class="flex flex-col h-full bg-white dark:bg-slate-950 transition-all duration-500 border-r border-lime-100 dark:border-lime-900/30">
    ...
    <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto custom-scrollbar">
        ...
        {{-- 3/31/2026 Edit Bayu - Menggunakan UI terbaru untuk fitur E-Learning --}}
        <a href="{{ route('member.shortcourse.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all group {{ request()->routeIs('member.shortcourse.*') ? 'bg-lime-400 text-slate-900 shadow-xl shadow-lime-400/20' : 'text-slate-500 dark:text-slate-400 hover:bg-lime-50 dark:hover:bg-lime-900/20 hover:text-lime-600 dark:hover:text-lime-400' }}">
        ...
        <a href="{{ route('member.knowledge.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all group {{ request()->routeIs('member.knowledge.*') ? 'bg-lime-400 text-slate-900 shadow-xl shadow-lime-400/20' : 'text-slate-500 dark:text-slate-400 hover:bg-lime-50 dark:hover:bg-lime-900/20 hover:text-lime-600 dark:hover:text-lime-400' }}">
            ...
            <span x-show="sidebarOpen" class="font-bold text-sm tracking-tight">Knowledge Hub</span>
        </a>

        <div class="pt-6">
            <p x-show="sidebarOpen" class="px-4 text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em] mb-4">Social Hub</p>

            <a href="#" class="flex items-center gap-4 px-4 py-3.5 rounded-2xl text-slate-500 dark:text-slate-400 hover:bg-lime-50 dark:hover:bg-lime-900/20 hover:text-lime-600 dark:hover:text-lime-400 transition-all group">
        ...
        <div class="pt-6">
            ...
            <a href="{{ route('admin.learning.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all group {{ request()->is('admin/learning*') ? 'bg-slate-900 dark:bg-slate-800 text-lime-400 shadow-xl shadow-slate-900/20' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-800' }}">
            ...
            <a href="{{ route('admin.certificates.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all group {{ request()->is('admin/certificates*') ? 'bg-slate-900 dark:bg-slate-800 text-lime-400 shadow-xl shadow-slate-900/20' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 dark:hover:bg-slate-800' }}">
