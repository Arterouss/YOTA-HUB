<div class="flex flex-col h-full bg-white dark:bg-slate-950 transition-all duration-500 border-r border-lime-100 dark:border-lime-900/30">
    ...
    <nav class="flex-1 px-4 py-8 space-y-2 overflow-y-auto custom-scrollbar">
        ...
        <a href="{{ route('member.knowledge.index') }}" class="flex items-center gap-4 px-4 py-3.5 rounded-2xl transition-all group {{ request()->routeIs('member.knowledge.*') ? 'bg-lime-400 text-slate-900 shadow-xl shadow-lime-400/20' : 'text-slate-500 dark:text-slate-400 hover:bg-lime-50 dark:hover:bg-lime-900/20 hover:text-lime-600' }}">
