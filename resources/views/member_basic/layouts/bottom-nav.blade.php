    ...
    <div class="flex justify-between items-center max-w-md mx-auto relative">
        ...
        <a href="#"
           class="flex flex-col items-center gap-1 group transition-all duration-300">
            ...
            <span class="text-[9px] font-black uppercase tracking-tighter {{ request()->routeIs('participant.dashboard') ? 'text-lime-600 dark:text-lime-400' : 'text-slate-400 dark:text-slate-500' }}">Home</span>
        </a>
        ...
        <a href="#" class="flex flex-col items-center gap-1 group transition-all duration-300">
            ...
            <span class="text-[9px] font-black uppercase tracking-tighter {{ request()->is('participant/courses*') ? 'text-lime-600 dark:text-lime-400' : 'text-slate-400 dark:text-slate-500' }}">Quest</span>
        </a>
        ...
        <a href="#" class="flex flex-col items-center gap-1 group transition-all duration-300">
            ...
            <span class="text-[9px] font-black uppercase tracking-tighter text-slate-400 dark:text-slate-500">Hub</span>
        </a>
        ...
        <a href="#" class="flex flex-col items-center gap-1 group transition-all duration-300">
            ...
            <span class="text-[9px] font-black uppercase tracking-tighter text-slate-400 dark:text-slate-500">Me</span>
        </a>
