        ...
        <div class="p-6">
            <div class="flex items-center text-xs text-gray-500 mb-2 gap-3">
                ...
                <span class="flex items-center gap-1">
                    ...
                    Sisa Kuota: {{ $seminar->quota_remaining }}
                </span>
                <span class="flex items-center gap-1 font-bold {{ $seminar->seminar_type == 'free' ? 'text-emerald-600' : 'text-blue-600' }}">
                    {{ $seminar->seminar_type == 'free' ? 'FREE' : 'Paid' }}
                </span>
            </div>
...
<!-- 3/31/2026 Edit Bayu - Menambahkan link navigasi Pagination -->
<div class="mt-8">
    {{ $seminars->links() }}
</div>
@endsection